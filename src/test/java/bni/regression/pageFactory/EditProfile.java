...
public class EditProfile {
    ...
    @FindBy (css="#memberGdproptin")
    WebElement splOfferEmailListBox;

    @FindBy(css="#updateContactDetails")
    WebElement updateButtonEditProfile;
    ...
    public void clickUpdateEditProfile(){
        updateButtonEditProfile.click();
    }
    public void selectSpecialOffer()
    {
        Select splOfferSelect = new Select (splOfferEmailListBox);
                splOfferSelect.selectByIndex(2);
    }
