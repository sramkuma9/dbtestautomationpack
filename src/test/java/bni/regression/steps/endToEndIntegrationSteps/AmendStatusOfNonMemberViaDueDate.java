...
public class AmendStatusOfNonMemberViaDueDate {
    ...
    public void  VerifyStatusOfNonMemberViaDueDate(DataTable loginDetails) throws Exception {
   ...
   // public void step_2(DataTable amendDueDateStatus) throws Exception {
    ...
    @When("^I Enter EmailId of the active member and click Search button, click hyperlink under type\\. On Edit profile page,Select Membership Details tab and click Amend Due Date$")
    public void i_Enter_EmailId_of_the_active_member_and_click_Search_button_click_hyperlink_under_type_On_Edit_profile_page_Select_Membership_Details_tab_and_click_Amend_Due_Date(DataTable amendDueDateStatus) throws Throwable {
        Integer i = 2;
        for (Map<String, String> data : amendDueDateStatus.asMaps(String.class, String.class)) {
            ...
            captureScreenShot.takeSnapShot(driver, "amendStatusOfNonMemberViaDueDate");
