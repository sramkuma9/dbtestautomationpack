...
public class ScheduleChange {
    ...
    @FindBy(xpath="//*[@id='root']/div[1]/main/div[2]/div/div[2]/div[1]/div/div[4]/dl/dd/div/button")
    WebElement changeTemplateHyperlink;

    @FindBy(xpath="//*[@id='root']/div[1]/main/div[2]/div/div[2]/div[3]/div/div[3]/button/span/span")
    WebElement scheduleChangeButton;


    @FindBy(xpath = "//div[@class='euiSuperSelect__listbox']")
    WebElement listBox;

    @FindBy(xpath="/html/body/div[2]/div[3]/div/div/div[3]/button[2]/span/span")
    WebElement confirmButton;


    public ScheduleChange(WebDriver driver) {
        ScheduleChange.driver = driver;
    ...
    public void clickChangeTemplateHyperlink()
    {
        changeTemplateHyperlink.click();
    }

    public void clickScheduleChangeButton()
    {
        scheduleChangeButton.click();
    }
