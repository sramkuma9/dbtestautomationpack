...
public class RegionWideAccess {
    ...
    public RegionWideAccess(WebDriver driver) {
        RegionWideAccess.driver = driver;
    ...
    public String checkRoleAssigned(String expName) {
        Integer breaker = 2;
        String result = "Region level role is not assigned successfully...";
        for (WebElement trElement : roleAssignedToList) {
            ...
            if (actualName.equals(expName)) {
                result = "Region level role assigned successfully...";
                breaker++;
                break;
            }
            if (breaker == 3) {
