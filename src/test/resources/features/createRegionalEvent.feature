...
#    Given I navigate to homepage using below details
#      | userName                | password     | country         | region        | chapter        |
#      | shanthibni+96@gmail.com | aadhira@2014 | Australia - BNI | BNI- Adelaide | Adelaide North |
#    When I enter the website with Regional level admin login details and navigate to Tools , click Events, Manage National Events,  click Create New Regional Event and enter below details and click Submit button and click Publish
