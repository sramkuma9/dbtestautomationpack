...
public class EnterNewMember {
    ...
    @FindBy(css="#requestedspeciality")
    WebElement requestedSpecialityTextBox;
...
//    @FindBy(css = "#applicationDate.field.required.hasDatepicker")
   @FindBy(xpath="//*[@id='applicationDate']")
    ...
    public EnterNewMember(WebDriver driver) {
        EnterNewMember.driver = driver;
    ...
    public void clickApplicationDateField() throws InterruptedException {
      // applicationDateTextBox.click();
        applicationDateTextBox.sendKeys(Keys.ARROW_DOWN);
    ...
    public void selectRequestedSpeciality(String requestedSpeciality)
    {
        requestedSpecialityTextBox.sendKeys(requestedSpeciality);
    }
}
