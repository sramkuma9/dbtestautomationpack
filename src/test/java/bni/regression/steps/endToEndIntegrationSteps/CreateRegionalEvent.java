...
//            bniConnect.navigateMenu("Tools,Events,Manage Events");
            TimeUnit.SECONDS.sleep(8);
            ...
            TimeUnit.SECONDS.sleep(1);
createNewEvent.enterCostForMember(data.get("costOfMember"));
            TimeUnit.SECONDS.sleep(1);
createNewEvent.enterCostForNonMember(data.get("costOfNonMember"));
            TimeUnit.SECONDS.sleep(1);
createNewEvent.enterFirstRemainderSent(data.get("firstRemainderSent"));
            ...
            captureScreenShot = new CaptureScreenShot(driver);
            captureScreenShot.takeSnapShot(driver, "createRegionalEvent");
