   ...
   # |saraha| Pass1word|Antarctica|Ant - Two|Chapter C|
       # |globalna| Pass1word|  Antarctica |Z_RG Test Region 6|Chapter A|
     #  |automation| Pass1word|  Antarctica |Ant - Two|Chapter C|
  #cc Test2 login -  |saraha|
     #   |admin     |Pass1word  |Australia - BNI      |christmas island_rename   |Aus CG Chapter |
      #   |admin     |Pass1word  |CC Test Country|Automation |CC CoreGroup|

  #  |Chapter A|  |Z_RG Test Region 6 |  | Selenium |  | Bni+mone  |   |Computer & Programming ||Computer Retailer| | English (US)| | BNI    |  | 23      |  | Feb        |  | 2020     |  | Ms.   |  | PSB Nagar      | | Airtel      |  | Antarctica |  | 123456789 | | Pass1word          ||Pass1word|
     # |Daffodil Chapter (SC)|  |B Region|  | Selenium|  | Bni+five  |  |Agriculture ||Agricultural Engineer|       | English (US)|| BNI |  |9     |  | Mar     |  | 2020     |  | Ms. |               | PSB Nagar      | | Airtel      |  | Antarctica |  | 123456789 |      | Pass1word          ||Pass1word|
     # |Daffodil Chapter (SC)|  |B Region|  | Selenium|  | Bni+six |  |Agriculture ||Agricultural Engineer|       | English (US)|| BNI |  |9     |  | Mar     |  | 2020     |  | Ms. |               | PSB Nagar      | | Airtel      |  | Antarctica |  | 123456789 |      | Pass1word          ||Pass1word|


#      |Chapter C|  | Ant - Two |  | Selenium |  | Bni+one  |   |Agriculture ||Agricultural Engineer|  | English (US)| |Reena vinoth   |  | 11     |  | Mar        |  | 2020     |  | Ms.   |  | PSB Nagar      | | Airtel      |  | Antarctica |  | 123456789 |
#      |Chapter C|  | Ant - Two |  | Selenium |  | Bni+two |   |Agriculture ||Agricultural Engineer|  | English (US)| |Reena vinoth   |  | 11     |  | Mar        |  | 2020     |  | Ms.   |  | PSB Nagar      | | Airtel      |  | Antarctica |  | 123456789 |
...
#      |Chapter R3A|  |Z_RG Test Réĝíón 3|  | Selenium|  | Bni+msix |    |Training & Coaching      ||z Training & Coaching Specialist|| BNI    |  | 8 |  | May |  | 2019      |  | Ms   |  | Airtel      |  | Antarctica |  | 123456789 |
     ...
     # |bekigoodwin|Pass1word |India         |Chènnai CBD (A)| Crown    |
  #    |bekigoodwin|Pass1word |Barbados         |Barbados Region| Bridgetown    |
    #  |admin |Pass1word|India         |Chènnai CBD (A) |CG 2 |
   #   | admin    | Pass1word | Antarctica | Ant - One | Ant - One - Chapter A |
  #|admin|Pass1word |Denmark |BNI Hovedstaden   |Vidhya Chapter1  |
   #   |admin|Pass1word |Uganda |Kampala   |Kamp C1|

   #  |Chapter A ||Z_RG Test Region 6        || Selenium |  | Bni+v104 |  |Animals ||Veterinarian|     | English (GB)|| BNI|  |7  |  | Jun     |  | 2020     |  | Mr jh|               | PSB Nagar      | | Airtel      |  | Antarctica |  | 123456789 | |Pass1word  ||Pass1word      |
      #|Chapter A ||Z_RG Test Region 6|| Selenium |  | Bni+v102 |  |Animals ||Veterinarian|     | English (GB)|| BNI|  |6  |  | May     |  | 2020     |  |Mr.|               | PSB Nagar      | | Airtel      |  | Antarctica |  | 123456789 | |Pass1word  ||Pass1word      |

    #  |Chapter C|  | Ant - Two |  | Selenium |  | Bni+v008 |   |Agriculture ||Agricultural Engineer|  | English (US)| |Reena vinoth   |  | 10     |  | Jun        |  | 2020     |  | Ms.   |  | PSB Nagar      | | Airtel      |  | Antarctica |  | 123456789 | |Pass1word  ||Pass1word      |
      #|BNI Ambassador|  |ACT - BNI Canberra |  | Selenium |  | Bni+A |    |Agriculture ||Agricultural Engineer|  | English (US)| |BNI |  | 16     |  | Jun        |  | 2020     |  | Ms.   |  | PSB Nagar      | | Airtel      |  | India |  | 123456789 | |Pass1word  ||Pass1word      |

   #  |CG 2|  |Chènnai CBD (A)|  | Selenium |  | Bni+v2 |   |Car & Motorcycle ||Auto/Car Body Shop|  | English (US)| |BNI |  | 14     |  | Jun        |  | 2020     |  | Ms.   |  | PSB Nagar      | | Airtel      |  | India |  | 123456789 | |Pass1word  ||Pass1word      |
   # | admin    | Pass1word | India   | Chènnai CBD (A) | CG 2    |
     # |admin|Pass1word |Uganda |Kampala   |Kamp C1|
     # |admin|Pass1word |CC Switzerland |Zurich  |Swizz Bliss|

       # | Kamp C1|  | Kampala |  | Selenium  |  | Bni+v3   |  | Car & Motorcycle |  | Auto/Car Body Shop |  | English (IN) |  | BNI    |  | 14       |  | Jun        |  | 2020      |  | Ms.   |  | PSB Nagar |  | Airtel      |  | India   |  | 123456789 |  | Pass1word   |  | Pass1word       |

    # | Swizz Bliss |  | Zurich  |  | Selenium  |  | Bni+v3   |  | Car & Motorcycle |  | Auto/Car Body Shop |  | English (IN) |  | BNI    |  | 14     |  | Jun        |  | 2020      |  | Ms.   |  | PSB Nagar |  | Airtel      |  | Switzerland   |  | 123456789 |  | Pass1word   |  | Pass1word       |
