        ...
        try {
            ...
            while ((output = br.readLine()) != null) {
                try {
                    ...
                    String path = readWritePropertyFile.loadAndReadPropertyFile("apiDownloadFilePath", "properties/config.properties")+ dateSplit[0] + "/" + dateSplit[1] + "/" + timeSplit[0] + "/" + featureName + timeSplit[1].replaceAll(":","-") + ".json";
