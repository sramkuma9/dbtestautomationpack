...
public class CreateAMember {
    ...
    public void tearDown() throws Exception {
     ...
     @Given("^Enter new Email ID and enter the details of the individual and add a new member$")
        public void enterNewEmailIDAndEnterTheDetailsOfTheIndividualAndAddANewMember(DataTable loginDetails) throws Exception {
        List<List<String>> login = loginDetails.raw();
        loginSubList = login.subList(1, login.size());
    }

    @When("I click Operations-Region, Enter New application, and add a member to a region")
    public void iclickoperationsregionenternewapplicationandaddamembertoaregion(DataTable createAMember) throws Exception {
        Integer i = 1;
        Integer j = 2;
