...
public class EnterPalmsAndDiscardPalms {
    ...
    public void step_2(DataTable enterPalms) throws Exception {
        ...
        for (Map<String, String> data : enterPalms.asMaps(String.class, String.class)) {
            ...
            TimeUnit.SECONDS.sleep(1);
            enterChapterPalms.clickDiscardPalmsButton();
            TimeUnit.SECONDS.sleep(2);
            ...
            viewChapterPalmsSummary.enterSearchCriteria("Discarded");
            TimeUnit.SECONDS.sleep(2);
            viewChapterPalmsSummary.checkStatusLink("Discarded");
            captureScreenShot = new CaptureScreenShot(driver);
            captureScreenShot.takeSnapShot(driver, "EnterPalmsAndDiscardPalms");
            TimeUnit.SECONDS.sleep(2);
            signOut.signOutBni();
            i++;
        }
