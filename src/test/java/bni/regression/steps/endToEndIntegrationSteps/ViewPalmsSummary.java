...
//            signOut.signOutBni();
            ...
            TimeUnit.SECONDS.sleep(5);
            viewChapterPalmsSummary.enterSearchCriteria(data.get("searchString"));
            TimeUnit.SECONDS.sleep(2);
            viewChapterPalmsSummary.clickStatusLink();
            TimeUnit.SECONDS.sleep(5);
            viewChapterPalms = new ViewChapterPalms(driver);
            viewChapterPalms.clickSlipsAuditReportButton();
            TimeUnit.SECONDS.sleep(8);
            slipsAuditReport = new SlipsAuditReport(driver);
            slipsAuditReport.clickExportButton();
